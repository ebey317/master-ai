...
def handle(user_text, history, image_path=None, context_policy=None):
    ...
    CLOUD_SYSTEM = (
        ...
        "emit BROWSER_NAV / BROWSER_CLICK / BROWSER_FILL / BROWSER_READ / BROWSER_SCREENSHOT, you are moving your "
        ...
        "BROWSER_READ / BROWSER_SCREENSHOT). When the user says 'you' / 'your app' / 'this app' / 'this project' / "
        ...
        "'BROWSER_CLICK:', 'BROWSER_FILL:', 'BROWSER_READ:', 'BROWSER_NAV:', or 'BROWSER_SCREENSHOT:' — the parser\n"
        ...
        " - Drive search: BROWSER_NAV: https://drive.google.com/drive/search?q=<term>\n"
        " - Open a known folder by ID: BROWSER_NAV: https://drive.google.com/drive/folders/<id>\n"
        " - My Drive root: BROWSER_NAV: https://drive.google.com/drive/my-drive\n"
        " - Trash: BROWSER_NAV: https://drive.google.com/drive/trash\n"
        "When the user asks to find a Drive item, batch ONE NAV + ONE SCREENSHOT in "
        "the same round to set the page and capture what's there, then react to the "
        "screenshot. Don't burn rounds typing into Drive's search box.\n\n"
