...
def handle(user_text, history, image_path=None, context_policy=None):
    ...
    CLOUD_SYSTEM = (
        ...
        "emit BROWSER_NAV / BROWSER_CLICK / BROWSER_FILL / BROWSER_READ / BROWSER_SCREENSHOT / "
        "BROWSER_WAIT / BROWSER_SCROLL / BROWSER_DOUBLE_CLICK / BROWSER_FIND / BROWSER_EXTRACT_LIST / "
        "BROWSER_DRIVE_INSPECT_FOLDER, you are moving your "
        ...
        "BROWSER_READ / BROWSER_SCREENSHOT / BROWSER_WAIT / BROWSER_SCROLL / BROWSER_DOUBLE_CLICK / "
        ...
        "BROWSER_READ: <css-selector or \"main\">   — read text content back from the page\n"
        ...
        "'BROWSER_CLICK:', 'BROWSER_FILL:', 'BROWSER_READ:', 'BROWSER_NAV:', 'BROWSER_SCREENSHOT:', "
        "'BROWSER_WAIT:', 'BROWSER_SCROLL:', 'BROWSER_DOUBLE_CLICK:', 'BROWSER_FIND:', "
        "'BROWSER_EXTRACT_LIST:', or 'BROWSER_DRIVE_INSPECT_FOLDER:' — the parser\n"
        ...
        "VERIFICATION DISCIPLINE — before DONE on any state-changing action "
        "(submit, upload, account creation, auth, payment, save, send, post, "
        "delete, the last click in a multi-step flow), emit a verification "
        "round FIRST: BROWSER_READ on the page's success/error banner region "
        "AND BROWSER_SCREENSHOT viewport. Read the result envelope in the "
        "next [PREVIOUS ROUND RESULTS]. Only emit DONE in the round AFTER, "
        "citing the observed evidence (\"Page shows: 'Application "
        "submitted, reference #ABC123'\" or \"Form values landed: "
        "firstName=Elijah, lastName=W., …\"). Without verification, DONE "
        "is a claim, not a confirmation — Anthropic's Claude for Chrome "
        "reviews the filled form with the user before clicking submit on "
        "anything consequential, and reports observed state after. Mirror "
        "that. For read-only goals (list folder contents, find a link, "
        "screenshot a page), the verification IS the action — no separate "
        "round needed. For state-changing goals, the verification round is "
        "NON-OPTIONAL.\n\n"
        ...
        "render fast); (d) before a submit CLICK → BROWSER_WAIT 500 then "
        "verify per VERIFICATION DISCIPLINE. Reads and screenshots don't "
        ...
        "lags behind its rendered UI, so BROWSER_READ misses elements visible in a "
