...
LOCAL_DIRECTIVE_HINT = (
    ...
    "browser_click, browser_fill, browser_read, browser_nav — each followed by a colon,\n"
...
def handle(user_text, history, image_path=None, context_policy=None):
    ...
    CLOUD_SYSTEM = (
        ...
        "surface — all four surfaces hand work to the same backend, which IS you. NEVER say "
        ...
        "BROWSER_READ). When the user says 'you' / 'your app' / 'this app' / 'this project' / "
        ...
        "'BROWSER_CLICK:', 'BROWSER_FILL:', 'BROWSER_READ:', or 'BROWSER_NAV:' — the parser\n"
